            ...
            <div class="table-responsive p-0">
                ...
                <form role="form" class="text-start">
                    ...
                    <div class="input-group input-group-outline mb-3">
                        ...
                        <input type="userrole" class="form-control">
                    </div>
                    <div class="input-group input-group-outline mb-3">
                        <label class="form-label">User Status</label>
                        <input type="userstatus" class="form-control">
                    </div> -->
                    <div class="text-center">
                        <button type="button" class="btn bg-gradient-primary w-100 my-4 mb-2">Add Page</button>
                    </div>
                </form>
                </div>
            </div>
